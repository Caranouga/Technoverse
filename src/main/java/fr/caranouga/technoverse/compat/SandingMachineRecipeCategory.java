...
public class SandingMachineRecipeCategory implements IRecipeCategory<SandingRecipe> {
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(Technoverse.MODID, "sanding_machine");
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Technoverse.MODID, "textures/gui/jei/sanding_machine.png");
    ...
    public Component getTitle() {
        return Component.translatable("jei." + Technoverse.MODID + ".sanding_machine");
    }
